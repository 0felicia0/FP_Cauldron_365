            ...
            for potion in potions_delivered:
               for row in result:
                    ...
                    if potion.potion_type == potion_mix:
                        ...
                        red_ml_used -= row.red_ml
                        green_ml_used -= row.green_ml
                        blue_ml_used -= row.blue_ml
                        
                        connection.execute(sqlalchemy.text("UPDATE potions SET num_potions = num_potions + :potions_to_add WHERE potions.potion_type = :potion_mix"), {"potions_to_add": potions_to_add, "potion_mix": potion_mix})
