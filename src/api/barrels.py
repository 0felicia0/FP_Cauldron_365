    ...
    with db.engine.begin() as connection:
            ...
            for barrel in wholesale_catalog:
                 ...
                 if "RED" in barrel.sku:
                    print("in red plan")
                    if red_potions < 10:
                        print("gold avail: ", gold_available)
                        print("quantity: ", quantity)
                        print("potential red: ", potential_red_potions)
                        print("barrel price: ", barrel.price)
                        while gold_available >= barrel.price and quantity < barrel.quantity and potential_red_potions < 5:
                    ...
                    if green_potions < 10:
                        ...
                        while gold_available >= barrel.price and quantity < barrel.quantity and potential_green_potions < 5:
                             quantity += 1
                    ...
                    if blue_potions < 10:
                        ...
                        while gold_available >= barrel.price and quantity < barrel.quantity and potential_blue_potions < 5:
                             quantity += 1
